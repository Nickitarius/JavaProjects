...
import model.InvertedIndexByte;
...
//        index.indexDocument("collection/folder2/King_Lear.txt");
        ...
        InvertedIndexByte ib = new InvertedIndexByte(index.getDocuments(), index.getIndex(), index.stopWords);

        FileOutputStream fos1 = new FileOutputStream("indexByte1.out");
